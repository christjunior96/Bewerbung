...
import Settings from 'components/Organism/account/Settings';
...
export default function Home(props: InferGetServerSidePropsType<typeof getServerSideProps>) {
    ...
    return (
        ...
        <main>
            <Section>
                <AccountWrapper headline='Einstellungen' selected='item8' name='Herr Diaz Rodriguez' bildUrl='/metzger.jpg' letzterLogin='27.02.2023, 07:45'>
                    <Settings/>
                </AccountWrapper>
            </Section>
        </main>
