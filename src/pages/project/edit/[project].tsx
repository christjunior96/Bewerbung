...
export default function Home(props: InferGetServerSidePropsType<typeof getServerSideProps>) {
    ...
    const [logo, setLogo] = useState(props.page.logoUrl)
    ...
    <main>
        <Section sectionSpace={10}>
            <Column justifyContent='center'>
                    ...
                    <StyledTextInput onChange={setLogo} value={logo} description='Seiten Logo' placeholder='/logo1.png'/>
                    <Space height={10}/>
        ...
        {jsonComp.map((comp: any, index: number) =>{
            if(comp.type == "Headline"){
              ...
              return (
                ...
                <Section backgroundColor={'--MALDIVES'} sectionSpace={15}>
                  <Column>
